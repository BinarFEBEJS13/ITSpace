  ...
  return (
    <div className="flex justify-center mb-5">
      <div className="flex flex-col justify-center ml-0 sm:ml-4 mt-[2rem] sm:mt-4 w-[23rem] mobile sm:w-[18rem] px-5">
        <h2 className="flex w-[90%] sm:w-full text-[1.5rem] sm:text-lg text-start sm:justify-center font-extrabold">
          Ubah Password
        </h2>
            ...
            <div className="flex items-center justify-end">
              ...
              <span className="absolute mr-3 text-ungu-0 text-[20px]">
                {oldPass === false ? (
                  ...
                  <AiFillEye onClick={toggleOldPassword} />
                )}
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-end">
              ...
              <span className="absolute mr-3 text-ungu-0 text-[20px]">
                {newPass === false ? (
                  ...
                  <AiFillEye onClick={toggleNewPassword} />
                )}
              </span>
            </div>
          </div>
