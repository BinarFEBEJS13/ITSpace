    ...
    <>
      <div className="flex justify-center items-center">
        <div className="flex flex-col justify-center items-center gap-4 w-full">
          <h2 className="text-ungu-0 font-bold text-xl text-center">Maaf Kelas Tidak Ditemukan!</h2>
          <img src={belumlogin} alt="" />
          <div className="text-center">
            <p className="text-sm sm:text-base">Silakan masuk ke akunmu untuk untuk melihat kelas</p>
          </div>
