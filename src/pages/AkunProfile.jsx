...
export const AkunProfile = () => {
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden sm:bg-white">
      <Navbar></Navbar>
      <div
        className="hidden sm:flex justify-start sm:justify-center cursor-pointer"
        onClick={() => navigate("/")}
      >
        <div className="flex justify-start w-[55%] sm:w-[60%] md:w-[89%] lg:w-[71%] xl:w-[58%] px-0 mt-5">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center">
        <div className="flex px-0 sm:w-[80%] md:w-[80%] lg:w-[65%] xl:w-[53%] mt-8">
          <div className="relative flex flex-col bg-transparent sm:bg-white sm:border-[1.5px] sm:border-[#6148FF] w-full h-[550px] bottom-5 rounded-xl z-0">
            <div className="hidden sm:flex sm:static w-full min-h-[40px] justify-center items-center rounded-tl-xl rounded-tr-xl bg-[#6148FF] text-white font-semibold tracking-[1px] z-10">
              Akun
            </div>
            <div className="hidden sm:flex justify-center">
              <h1 className="flex w-[90%] sm:hidden text-[1.5rem] font-extrabold">
                Akun
              </h1>
            </div>
            <div className="flex w-full justify-center sm:gap-4 mt-2 sm:mt-0 sm:overflow-hidden">
              {/* Bagian Kiri */}
              <div className="hidden sm:flex flex-row justify-center sm:justify-start w-[90%] sm:w-[18rem] bg-white sm:bg-transparent shadow-lg sm:shadow-none rounded-xl">
                <div className="hidden sm:flex flex-col justify-start w-[90%] gap-3 sm:ml-4 mt-4 sm:w-[18rem]">
                    ...
                    {Akun === "profile" ? (
                      <div className="flex items-center space-x-3">
                        <img
                          ...
                          alt=""
                        ></img>
                        <p className="font-bold text-[#6148FF] text-[15px]">
                          Profil Saya
                        </p>
                      </div>
                    ) : (
                  ...
                  <div
                    onClick={() => handleAccount("changepass")}
                    className="flex items-center space-x-3 cursor-pointer"
                  >
                    {Akun === "changepass" ? (
                      <div className="flex items-center space-x-3">
                  ...
                  <hr className="border-[1px]"></hr>
                  <div
                    onClick={() => handleAccount("transaction")}
                    className="flex items-center space-x-3 cursor-pointer"
                  >
                    {Akun === "transaction" ? (
                      <div className="flex items-center space-x-3">
                  ...
                  <hr className="border-[1px]"></hr>
                  <p className="text-center text-[12px] text-gray-400 my-4 sm:mt-4">
                    Version 1.1.0
                  </p>
                </div>
              </div>
